...
public class rentedRoomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rented_room);
        recyclerView = findViewById(R.id.recyclerView);
        myId = getIntent().getStringExtra("myId");

        DatabaseReference ordersRef = FirebaseDatabase.getInstance().getReference("orders");
        Query userOrdersQuery = ordersRef.orderByChild("myId").equalTo(myId);
                ...
                if (!roomIds.isEmpty()) {
                    ...
                    roomsRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            roomAdapter = new RoomAdapter(rentedRoomActivity.this, userRooms, myId);
                            recyclerView.setAdapter(roomAdapter);
                            recyclerView.setLayoutManager(new LinearLayoutManager(rentedRoomActivity.this));
                        }
